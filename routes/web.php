...
Route::group(['middleware' => ['auth'], 'prefix' => 'admin', 'as' => 'admin.'], function () {
    ...
    Route::resource('risk_types', 'Admin\RiskTypesController');
    Route::post('risk_types_mass_destroy', ['uses' => 'Admin\RiskTypesController@massDestroy', 'as' => 'risk_types.mass_destroy']);
    Route::post('risk_types_restore/{id}', ['uses' => 'Admin\RiskTypesController@restore', 'as' => 'risk_types.restore']);
    Route::delete('risk_types_perma_del/{id}', ['uses' => 'Admin\RiskTypesController@perma_del', 'as' => 'risk_types.perma_del']);
    Route::resource('risk_impacts', 'Admin\RiskImpactsController');
    Route::post('risk_impacts_mass_destroy', ['uses' => 'Admin\RiskImpactsController@massDestroy', 'as' => 'risk_impacts.mass_destroy']);
    Route::post('risk_impacts_restore/{id}', ['uses' => 'Admin\RiskImpactsController@restore', 'as' => 'risk_impacts.restore']);
    Route::delete('risk_impacts_perma_del/{id}', ['uses' => 'Admin\RiskImpactsController@perma_del', 'as' => 'risk_impacts.perma_del']);
    Route::resource('risk_probabilities', 'Admin\RiskProbabilitiesController');
    Route::post('risk_probabilities_mass_destroy', ['uses' => 'Admin\RiskProbabilitiesController@massDestroy', 'as' => 'risk_probabilities.mass_destroy']);
    Route::post('risk_probabilities_restore/{id}', ['uses' => 'Admin\RiskProbabilitiesController@restore', 'as' => 'risk_probabilities.restore']);
    Route::delete('risk_probabilities_perma_del/{id}', ['uses' => 'Admin\RiskProbabilitiesController@perma_del', 'as' => 'risk_probabilities.perma_del']);
    Route::resource('risk_proximities', 'Admin\RiskProximitiesController');
    Route::post('risk_proximities_mass_destroy', ['uses' => 'Admin\RiskProximitiesController@massDestroy', 'as' => 'risk_proximities.mass_destroy']);
    Route::post('risk_proximities_restore/{id}', ['uses' => 'Admin\RiskProximitiesController@restore', 'as' => 'risk_proximities.restore']);
    Route::delete('risk_proximities_perma_del/{id}', ['uses' => 'Admin\RiskProximitiesController@perma_del', 'as' => 'risk_proximities.perma_del']);
