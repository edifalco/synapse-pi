    ...
    public function testCreateDeliverable()
    {
        ...
        $this->browse(function (Browser $browser) use ($admin, $deliverable, $relations) {
            $browser->loginAs($admin)
                ...
                ->clickLink('Add new')
                ->select("workpackage_id", $deliverable->workpackage_id)
                ...
                ->assertSeeIn("tr:last-child td[field-key='workpackage']", $deliverable->workpackage->wp_id)
    ...
    public function testEditDeliverable()
    {
        ...
        $this->browse(function (Browser $browser) use ($admin, $deliverable, $deliverable2, $relations) {
            $browser->loginAs($admin)
                ...
                ->select("workpackage_id", $deliverable2->workpackage_id)
                ...
                ->press('Update')
                ->assertRouteIs('admin.deliverables.index')
                ->assertSeeIn("tr:last-child td[field-key='workpackage']", $deliverable2->workpackage->wp_id)
    ...
    public function testShowDeliverable()
    {
        ...
        $this->browse(function (Browser $browser) use ($admin, $deliverable, $relations) {
            $browser->loginAs($admin)
                ...
                ->assertSeeIn("td[field-key='workpackage']", $deliverable->workpackage->wp_id)
