    ...
    public function testCreateDeliverable()
    {
        ...
        $this->browse(function (Browser $browser) use ($admin, $deliverable) {
            $browser->loginAs($admin)
                ...
                ->select("idStatus_id", $deliverable->idStatus_id)
                ...
                ->assertSeeIn("tr:last-child td[field-key='idStatus']", $deliverable->idStatus->label)
    ...
    public function testEditDeliverable()
    {
        ...
        $this->browse(function (Browser $browser) use ($admin, $deliverable, $deliverable2) {
            $browser->loginAs($admin)
                ...
                ->select("idStatus_id", $deliverable2->idStatus_id)
                ...
                ->assertSeeIn("tr:last-child td[field-key='idStatus']", $deliverable2->idStatus->label)
    ...
    public function testShowDeliverable()
    {
        ...
        $this->browse(function (Browser $browser) use ($admin, $deliverable) {
            $browser->loginAs($admin)
                ...
                ->assertSeeIn("td[field-key='idStatus']", $deliverable->idStatus->label)
