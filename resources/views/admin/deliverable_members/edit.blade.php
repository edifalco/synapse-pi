...
@section('content')
    ...
    {!! Form::model($deliverable_member, ['method' => 'PUT', 'route' => ['admin.deliverable_members.update', $deliverable_member->id]]) !!}
        ...
        <div class="panel-body">
            <div class="row">
                <div class="col-xs-12 form-group">
                    {!! Form::label('member_id', trans('global.deliverable-members.fields.member').'', ['class' => 'control-label']) !!}
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    {!! Form::label('deliverable_id', trans('global.deliverable-members.fields.deliverable').'', ['class' => 'control-label']) !!}
