...
@section('content')
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body table-responsive">
            <table class="table table-bordered table-striped ajaxTable @can('threshold_risk_delete') @if ( request('show_deleted') != 1 ) dt-select @endif @endcan">
                <thead>
                    <tr>
...
@section('javascript') 
    <script>
        ...
        $(document).ready(function () {
            window.dtDefaultOptions.ajax = '{!! route('admin.threshold_risks.index') !!}?show_deleted={{ request('show_deleted') }}';
            window.dtDefaultOptions.columns = [@can('threshold_risk_delete')
                @if ( request('show_deleted') != 1 )
