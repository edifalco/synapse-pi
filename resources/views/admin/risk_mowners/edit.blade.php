...
@section('content')
    ...
    {!! Form::model($risk_mowner, ['method' => 'PUT', 'route' => ['admin.risk_mowners.update', $risk_mowner->id]]) !!}
        ...
        <div class="panel-body">
            <div class="row">
                <div class="col-xs-12 form-group">
                    {!! Form::label('member_id', trans('global.risk-mowners.fields.member').'', ['class' => 'control-label']) !!}
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    {!! Form::label('risk_id', trans('global.risk-mowners.fields.risk').'', ['class' => 'control-label']) !!}
