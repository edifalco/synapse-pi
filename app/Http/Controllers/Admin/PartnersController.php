...
class PartnersController extends Controller
{
    ...
    public function show($id)
    {
        ...
        return view('admin.partners.show', compact('partner', 'budgets', 'partnerroles', 'risk_powners', 'risk_preporters', 'deliverable_partners', 'acronyms', 'member_partners', 'acronym_projects', 'partnernums', 'project_members', 'teams', 'members', 'efforts', 'projects'));
    }
