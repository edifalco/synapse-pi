...
class ProjectsController extends Controller
{
    ...
    public function show($id)
    {
        ...
        $partners = \App\Partner::get()->pluck('name', 'id');
$project_members = \App\ProjectMember::where('project_id', $id)->get();$risks = \App\Risk::where('project_id', $id)->get();$efforts = \App\Effort::where('project_id', $id)->get();$alternativescores = \App\Alternativescore::where('project_id', $id)->get();$metriclabels = \App\Metriclabel::where('project_id', $id)->get();$project_users = \App\ProjectUser::where('projectID_id', $id)->get();$risk_highlights = \App\RiskHighlight::where('project_id', $id)->get();$scoredescriptions = \App\Scoredescription::where('project_id', $id)->get();$threshold_deliverables = \App\ThresholdDeliverable::where('project_id', $id)->get();$threshold_risks = \App\ThresholdRisk::where('project_id', $id)->get();$documents = \App\Document::where('project_id', $id)->get();$document_favorites = \App\DocumentFavorite::where('project_id', $id)->get();$financials = \App\Financial::where('project_id', $id)->get();$financialvisibilities = \App\Financialvisibility::where('id_project_id', $id)->get();$acronym_projects = \App\AcronymProject::where('project_id', $id)->get();$teams = \App\Team::where('project_id', $id)->get();$cd_disseminations = \App\CdDissemination::where('project_id', $id)->get();$metricicons = \App\Metricicon::where('project_id', $id)->get();$cd_emails = \App\CdEmail::where('project_id', $id)->get();$cd_intranet_accesses = \App\CdIntranetAccess::where('project_id', $id)->get();$partnernums = \App\Partnernum::where('project_id', $id)->get();$cd_meetings = \App\CdMeeting::where('project_id', $id)->get();$partnerroles = \App\Partnerrole::where('project_id', $id)->get();$cd_scores = \App\CdScore::where('project_id', $id)->get();$cd_scores2s = \App\CdScores2::where('project_id', $id)->get();$schedules = \App\Schedule::where('project_id', $id)->get();$workpackages = \App\Workpackage::where('project_id', $id)->get();$project_periods = \App\ProjectPeriod::where('project_id', $id)->get();$budgets = \App\Budget::where('project_id', $id)->get();$posts = \App\Post::where('project_id', $id)->get();$agendas = \App\Agenda::where('project_id', $id)->get();$publications = \App\Publication::where('project_id', $id)->get();$deliverables = \App\Deliverable::where('project_id', $id)->get();

        $project = Project::findOrFail($id);

        return view('admin.projects.show', compact('project', 'project_members', 'risks', 'efforts', 'alternativescores', 'metriclabels', 'project_users', 'risk_highlights', 'scoredescriptions', 'threshold_deliverables', 'threshold_risks', 'documents', 'document_favorites', 'financials', 'financialvisibilities', 'acronym_projects', 'teams', 'cd_disseminations', 'metricicons', 'cd_emails', 'cd_intranet_accesses', 'partnernums', 'cd_meetings', 'partnerroles', 'cd_scores', 'cd_scores2s', 'schedules', 'workpackages', 'project_periods', 'budgets', 'posts', 'agendas', 'publications', 'deliverables'));
    }
