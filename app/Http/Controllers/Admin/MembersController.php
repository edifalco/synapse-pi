...
class MembersController extends Controller
{
    ...
    public function show($id)
    {
        ...
        return view('admin.members.show', compact('member', 'member_partners', 'memberroles', 'risk_mreporters', 'project_members', 'deliverable_reviewers', 'deliverables', 'risks'));
    }
